...
const resources = [
  ...
  },
  {
    ...
    description: "Modern IT operating models that align technology capabilities with business outcomes.",
    icon: "⚙️",
  },
  {
    title: "Innovation Scorecards & Templates",
    description: "Tools to measure and track innovation initiatives and their business impact.",
    icon: "📊",
  },
  {
    title: "Thought Leadership Articles",
    description: "Essential reading for IT leaders navigating digital disruption and business transformation.",
    icon: "📚",
  },
];
      ...
      <div className="container px-4 md:px-6 mx-auto">
            ...
            <Card key={index} className="border-0 shadow-sm hover:shadow-md transition-shadow rounded-xl overflow-hidden">
              {resource.link ? (
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-podcast-gray">{resource.description}</p>
                  <div className="mt-4">
                    <span className="text-podcast-purple font-medium text-sm">Coming soon...</span>
                  </div>
                </CardContent>
              )}
            </Card>
        ...
        <div className="mt-10 text-center">
          <div className="inline-block bg-white rounded-lg px-6 py-4 border border-dashed border-podcast-purple">
            <p className="text-podcast-purple font-medium">Coming soon: A downloadable toolkit for aspiring CIOs</p>
          </div>
        </div>
      </div>
    </section>
